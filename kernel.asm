...
80100bc7:	e8 d4 38 00 00       	call   801044a0 <strlen>
...
80100bd8:	e8 c3 38 00 00       	call   801044a0 <strlen>
...
80100cc8:	e8 93 37 00 00       	call   80104460 <safestrcpy>
  curproc->pgdir = pgdir;
80100ccd:	8b 8d f0 fe ff ff    	mov    -0x110(%ebp),%ecx
  oldpgdir = curproc->pgdir;
80100cd3:	8b 77 08             	mov    0x8(%edi),%esi
  curproc->szStack = 1;
80100cd6:	c7 47 04 01 00 00 00 	movl   $0x1,0x4(%edi)
  curproc->tf->eip = elf.entry;  // main
80100cdd:	8b 47 1c             	mov    0x1c(%edi),%eax
  curproc->pgdir = pgdir;
80100ce0:	89 4f 08             	mov    %ecx,0x8(%edi)
  curproc->sz = sz;
...
80100cf1:	89 50 38             	mov    %edx,0x38(%eax)
  curproc->tf->esp = sp;
80100cf4:	8b 47 1c             	mov    0x1c(%edi),%eax
80100cf7:	89 58 44             	mov    %ebx,0x44(%eax)
  switchuvm(curproc);
80100cfa:	89 3c 24             	mov    %edi,(%esp)
80100cfd:	e8 be 58 00 00       	call   801065c0 <switchuvm>
  freevm(oldpgdir);
80100d02:	89 34 24             	mov    %esi,(%esp)
80100d05:	e8 36 5c 00 00       	call   80106940 <freevm>
  return 0;
80100d0a:	31 c0                	xor    %eax,%eax
80100d0c:	e9 01 fd ff ff       	jmp    80100a12 <exec+0x72>
  for(argc = 0; argv[argc]; argc++) {
80100d11:	bb ff ff ff 7f       	mov    $0x7fffffff,%ebx
...
80100d45:	e8 06 33 00 00       	call   80104050 <initlock>
}
80100d4a:	c9                   	leave  
80100d4b:	c3                   	ret    
...
80100d63:	e8 d8 33 00 00       	call   80104140 <acquire>
...
80100d89:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      release(&ftable.lock);
80100d90:	e8 9b 34 00 00       	call   80104230 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100da7:	e8 84 34 00 00       	call   80104230 <release>
}
...
80100dd1:	e8 6a 33 00 00       	call   80104140 <acquire>
  if(f->ref < 1)
...
80100dea:	e8 41 34 00 00       	call   80104230 <release>
  return f;
}
...
80100e23:	e8 18 33 00 00       	call   80104140 <acquire>
  if(f->ref < 1)
...
80100e4a:	5d                   	pop    %ebp
    release(&ftable.lock);
80100e4b:	e9 e0 33 00 00       	jmp    80104230 <release>
  ff = *f;
...
80100e6c:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100e6f:	e8 bc 33 00 00       	call   80104230 <release>
  if(ff.type == FD_PIPE)
...
801011d8:	e8 a3 30 00 00       	call   80104280 <memset>
  log_write(bp);
...
80101219:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
8010121c:	e8 1f 2f 00 00       	call   80104140 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
80101256:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
80101259:	e8 d2 2f 00 00       	call   80104230 <release>
  ip->ref = 1;
  ip->valid = 0;
  release(&icache.lock);
...
8010129e:	e8 8d 2f 00 00       	call   80104230 <release>
}
...
801013b2:	e8 69 2f 00 00       	call   80104320 <memmove>
  brelse(bp);
...
8010147b:	e8 d0 2b 00 00       	call   80104050 <initlock>
...
80101490:	80 
80101491:	e8 aa 2a 00 00       	call   80103f40 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
80101599:	e8 e2 2c 00 00       	call   80104280 <memset>
      dip->type = type;
...
8010164f:	00 
80101650:	e8 cb 2c 00 00       	call   80104320 <memmove>
  log_write(bp);
...
80101681:	e8 ba 2a 00 00       	call   80104140 <acquire>
  ip->ref++;
80101686:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010168a:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101691:	e8 9a 2b 00 00       	call   80104230 <release>
}
...
801016c4:	e8 b7 28 00 00       	call   80103f80 <acquiresleep>
  if(ip->valid == 0){
...
8010173b:	e8 e0 2b 00 00       	call   80104320 <memmove>
    brelse(bp);
...
80101795:	e8 86 28 00 00       	call   80104020 <holdingsleep>
...
801017ad:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
801017ae:	e9 2d 28 00 00       	jmp    80103fe0 <releasesleep>
    panic("iunlock");
...
801017d2:	e8 a9 27 00 00       	call   80103f80 <acquiresleep>
...
801017e8:	e8 f3 27 00 00       	call   80103fe0 <releasesleep>
  acquire(&icache.lock);
801017ed:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801017f4:	e8 47 29 00 00       	call   80104140 <acquire>
  ip->ref--;
...
8010180a:	5d                   	pop    %ebp
  release(&icache.lock);
8010180b:	e9 20 2a 00 00       	jmp    80104230 <release>
    acquire(&icache.lock);
80101810:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101817:	e8 24 29 00 00       	call   80104140 <acquire>
    int r = ip->ref;
8010181c:	8b 5e 08             	mov    0x8(%esi),%ebx
    release(&icache.lock);
8010181f:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101826:	e8 05 2a 00 00       	call   80104230 <release>
    if(r == 1){
...
801019f8:	e8 23 29 00 00       	call   80104320 <memmove>
    brelse(bp);
...
80101af4:	e8 27 28 00 00       	call   80104320 <memmove>
    log_write(bp);
...
80101b9b:	e8 00 28 00 00       	call   801043a0 <strncmp>
}
80101ba0:	c9                   	leave  
80101ba1:	c3                   	ret    
...
80101c19:	e8 82 27 00 00       	call   801043a0 <strncmp>
      continue;
...
80101c98:	e8 a3 24 00 00       	call   80104140 <acquire>
  ip->ref++;
80101c9d:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101ca1:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101ca8:	e8 83 25 00 00       	call   80104230 <release>
...
80101d0b:	e8 10 26 00 00       	call   80104320 <memmove>
    path++;
...
80101d99:	e8 82 25 00 00       	call   80104320 <memmove>
    name[len] = 0;
...
80101e93:	e8 78 25 00 00       	call   80104410 <strncpy>
  de.inum = inum;
...
80102005:	e8 46 20 00 00       	call   80104050 <initlock>
...
80102080:	e8 bb 20 00 00       	call   80104140 <acquire>
...
801020ac:	e8 df 1c 00 00       	call   80103d90 <wakeup>
...
801020c6:	e8 65 21 00 00       	call   80104230 <release>
...
80102120:	e8 fb 1e 00 00       	call   80104020 <holdingsleep>
...
80102156:	e8 e5 1f 00 00       	call   80104140 <acquire>
...
801021b5:	5d                   	pop    %ebp
  release(&idelock);
801021b6:	e9 75 20 00 00       	jmp    80104230 <release>
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
...
8010231a:	e8 61 1f 00 00       	call   80104280 <memset>
...
801023ea:	e8 61 1c 00 00       	call   80104050 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801024bd:	e8 6e 1d 00 00       	call   80104230 <release>
  return (char*)r;
}
...
801024d7:	e8 64 1c 00 00       	call   80104140 <acquire>
...
8010288c:	e8 3f 1a 00 00       	call   801042d0 <memcmp>
...
801029b7:	e8 64 19 00 00       	call   80104320 <memmove>
...
80102a7a:	e8 d1 15 00 00       	call   80104050 <initlock>
  readsb(dev, &sb);
...
80102b0d:	e8 2e 16 00 00       	call   80104140 <acquire>
...
80102b55:	a3 bc 26 11 80       	mov    %eax,0x801126bc
      release(&log.lock);
80102b5a:	e8 d1 16 00 00       	call   80104230 <release>
      break;
    }
  }
}
...
80102b80:	e8 bb 15 00 00       	call   80104140 <acquire>
  log.outstanding -= 1;
...
80102bb8:	00 00 00 
  release(&log.lock);
80102bbb:	e8 70 16 00 00       	call   80104230 <release>
  if (log.lh.n > 0) {
...
80102c1f:	e8 fc 16 00 00       	call   80104320 <memmove>
...
80102cdd:	e8 5e 14 00 00       	call   80104140 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102d2e:	5d                   	pop    %ebp
  release(&log.lock);
80102d2f:	e9 fc 14 00 00       	jmp    80104230 <release>
...
80102e66:	e8 b5 14 00 00       	call   80104320 <memmove>
  for(c = cpus; c < cpus+ncpu; c++){
...
80102f3b:	e8 90 13 00 00       	call   801042d0 <memcmp>
...
80102ff6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80102ff9:	e8 d2 12 00 00       	call   801042d0 <memcmp>
...
801031d6:	80 
801031d7:	e8 74 0e 00 00       	call   80104050 <initlock>
  (*f0)->type = FD_PIPE;
...
80103261:	e8 da 0e 00 00       	call   80104140 <acquire>
  if(writable){
...
8010327d:	e8 0e 0b 00 00       	call   80103d90 <wakeup>
  } else {
    p->readopen = 0;
    wakeup(&p->nwrite);
  }
...
8010329e:	5d                   	pop    %ebp
    release(&p->lock);
8010329f:	e9 8c 0f 00 00       	jmp    80104230 <release>
...
801032ef:	e8 4c 0e 00 00       	call   80104140 <acquire>
  for(i = 0; i < n; i++){
...
8010333f:	e8 4c 0a 00 00       	call   80103d90 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
...
80103372:	e8 b9 0e 00 00       	call   80104230 <release>
        return -1;
...
801033ba:	e8 d1 09 00 00       	call   80103d90 <wakeup>
  release(&p->lock);
801033bf:	89 1c 24             	mov    %ebx,(%esp)
801033c2:	e8 69 0e 00 00       	call   80104230 <release>
  return n;
...
801033e2:	e8 59 0d 00 00       	call   80104140 <acquire>
...
8010343b:	e8 f0 0d 00 00       	call   80104230 <release>
...
80103495:	e8 f6 08 00 00       	call   80103d90 <wakeup>
  release(&p->lock);
8010349a:	89 34 24             	mov    %esi,(%esp)
8010349d:	e8 8e 0d 00 00       	call   80104230 <release>
}
...
801034c3:	e8 78 0c 00 00       	call   80104140 <acquire>
...
801034fe:	89 43 14             	mov    %eax,0x14(%ebx)
  release(&ptable.lock);
80103501:	e8 2a 0d 00 00       	call   80104230 <release>
...
8010353a:	89 43 20             	mov    %eax,0x20(%ebx)
  memset(p->context, 0, sizeof *p->context);
8010353d:	e8 3e 0d 00 00       	call   80104280 <memset>
...
8010355f:	e8 cc 0c 00 00       	call   80104230 <release>
}
...
8010358d:	e8 9e 0c 00 00       	call   80104230 <release>
...
801035e5:	e8 66 0a 00 00       	call   80104050 <initlock>
}
801035ea:	c9                   	leave  
801035eb:	c3                   	ret    
...
80103694:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103697:	e8 64 0a 00 00       	call   80104100 <pushcli>
  c = mycpu();
8010369c:	e8 4f ff ff ff       	call   801035f0 <mycpu>
  p = c->proc;
801036a1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801036a7:	e8 14 0b 00 00       	call   801041c0 <popcli>
}
...
80103717:	e8 64 0b 00 00       	call   80104280 <memset>
...
8010377e:	e8 dd 0c 00 00       	call   80104460 <safestrcpy>
  p->cwd = namei("/");
...
8010387f:	0f 84 b0 00 00 00    	je     80103935 <fork+0xf5>
  np->sz = curproc->sz;
...
8010388f:	89 02                	mov    %eax,(%edx)
  np->szStack = curproc->szStack;
80103891:	8b 43 04             	mov    0x4(%ebx),%eax
  *np->tf = *curproc->tf;
80103894:	8b 7a 1c             	mov    0x1c(%edx),%edi
  np->parent = curproc;
80103897:	89 5a 18             	mov    %ebx,0x18(%edx)
  np->szStack = curproc->szStack;
8010389a:	89 42 04             	mov    %eax,0x4(%edx)
  *np->tf = *curproc->tf;
8010389d:	8b 73 1c             	mov    0x1c(%ebx),%esi
801038a0:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
801038a2:	31 f6                	xor    %esi,%esi
  np->kstack = curproc->kstack;
801038a4:	8b 43 0c             	mov    0xc(%ebx),%eax
801038a7:	89 42 0c             	mov    %eax,0xc(%edx)
  np->tf->eax = 0;
801038aa:	8b 42 1c             	mov    0x1c(%edx),%eax
801038ad:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
...
80103d26:	e8 b5 e5 ff ff       	call   801022e0 <kfree>
        freevm(p->pgdir);
...
80103fb2:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80103fb8:	e8 d3 f6 ff ff       	call   80103690 <myproc>
...
801040e5:	e8 06 f5 ff ff       	call   801035f0 <mycpu>
...
80104172:	e8 79 f4 ff ff       	call   801035f0 <mycpu>
...
8010419b:	e8 50 f4 ff ff       	call   801035f0 <mycpu>
  if(holding(lk))
...
801041cb:	75 49                	jne    80104216 <popcli+0x56>
  ...
  if(--mycpu()->ncli < 0)
801041cd:	e8 1e f4 ff ff       	call   801035f0 <mycpu>
...
801041e5:	e8 06 f4 ff ff       	call   801035f0 <mycpu>
...
801041f6:	66 90                	xchg   %ax,%ax
  if(mycpu()->ncli == 0 && mycpu()->intena)
801041f8:	e8 f3 f3 ff ff       	call   801035f0 <mycpu>
...
80104253:	e8 98 f3 ff ff       	call   801035f0 <mycpu>
  if(!holding(lk))
...
80105538:	e8 53 e1 ff ff       	call   80103690 <myproc>
...
8010555c:	e8 0f e1 ff ff       	call   80103670 <cpuid>
...
8010556c:	e8 1f e1 ff ff       	call   80103690 <myproc>
80105571:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105574:	e8 17 e1 ff ff       	call   80103690 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
801056af:	e8 9c af ff ff       	call   80100650 <cprintf>
    lapiceoi();
801056b4:	e8 b7 d0 ff ff       	call   80102770 <lapiceoi>
    break;
801056b9:	e9 02 ff ff ff       	jmp    801055c0 <trap+0xb0>
801056be:	66 90                	xchg   %ax,%ax
    ideintr();
801056c0:	e8 ab c9 ff ff       	call   80102070 <ideintr>
...
801056da:	75 2c                	jne    80105708 <trap+0x1f8>
    myproc()->tf = tf;
801056dc:	e8 af df ff ff       	call   80103690 <myproc>
801056e1:	89 58 1c             	mov    %ebx,0x1c(%eax)
    syscall();
801056e4:	e8 37 ef ff ff       	call   80104620 <syscall>
    if(myproc()->killed)
801056e9:	e8 a2 df ff ff       	call   80103690 <myproc>
...
80105746:	e8 25 df ff ff       	call   80103670 <cpuid>
